...
def test_dataset_tag():
    ...
    assert os.path.exists(
        f"{prior.DATASET_DIR}/mattdeitke/test-dataset/ea5910db0d8c261ed25fc4b86aed8aed7a62f24f"
    )
...
def test_dataset_branch():
    ...
    assert os.path.exists(
        f"{prior.DATASET_DIR}/mattdeitke/test-dataset/21993c22a02fa69d5fa593c10f57f3e9865cc803"
    )
...
def test_dataset_commit_id():
    ...
    assert os.path.exists(
        f"{prior.DATASET_DIR}/mattdeitke/test-dataset/950feaf63e60b7e55c723c21bde7eaf85a0f5bd7"
    )
...
def test_dataset_default_test():
    ...
    assert os.path.exists(
        f"{prior.DATASET_DIR}/mattdeitke/test-dataset/d2ae4c9de166dd69c23a3a35c1f281fff5e8efab"
    )
